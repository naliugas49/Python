...
# preferente), donde preferente tendrá el valor True si se trata de un #cliente preferente. El programa debe preguntar al usuario por una opción 
# del siguiente menú: (1) Añadir cliente, (2) Eliminar cliente, (3) Mostrar cliente, (4) Listar todos #los clientes, (5) Listar clientes 
...
option = input ('Seleccione una de las siguientes opciones:\n'
                    ...
                    '6-Terminar\n')
if option == '1':
    nif = input('introduzca su numero NIF')
